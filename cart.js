...
function generateCartItems(cartItems){
  ...
  cartItems.forEach((item) => {
    ...
    <div class="cart-item-counter w-48 flex items-center ">
         <div data-id = "${item.id}" class="cart-item-decrease cursor-pointer text-gray-400 bg-gray-100 rounded-lg h-6 w-6 flex justify-center items-center hover:bg-gray-200 mr-2">
         <i class="fas fa-chevron-left"></i>
          </div>
          <h4 class="text-gray-400 ">${item.quantity}</h4>
          <div data-id = "${item.id}"  class="cart-item-increase cursor-pointer text-gray-400 bg-gray-100 rounded-lg h-6 w-6 flex justify-center items-center hover:bg-gray-200 ml-2">
    ...
    <div data-id = "${item.id}" class="cart-item-remove w-10 font-bold text-gray-300 cursor-pointer hover:text-gray-400">
...
function createEventListeners(){
  ...
  let deleteButtons = document.querySelectorAll(".cart-item-remove");
